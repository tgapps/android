...
abstract class AbstractConcatenatedTimeline extends Timeline {
    ...
    public final Object getUidOfPeriod(int periodIndex) {
        int childIndex = getChildIndexByPeriodIndex(periodIndex);
        return Pair.create(getChildUidByChildIndex(childIndex), getTimelineByChildIndex(childIndex).getUidOfPeriod(periodIndex - getFirstPeriodIndexByChildIndex(childIndex)));
    }
