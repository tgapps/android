...
public final class zzcfh extends zzchj {
    ...
    zzcfh(zzcgl com_google_android_gms_internal_zzcgl) {
    ...
    public final boolean zza(zzcez com_google_android_gms_internal_zzcez) {
        Parcel obtain = Parcel.obtain();
        com_google_android_gms_internal_zzcez.writeToParcel(obtain, 0);
    ...
    public final boolean zza(zzcji com_google_android_gms_internal_zzcji) {
        Parcel obtain = Parcel.obtain();
        com_google_android_gms_internal_zzcji.writeToParcel(obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:146:0x00fe
...
*/
    ...
    L_0x0082:
        ...
        r1 = com.google.android.gms.internal.zzcez.CREATOR;	 Catch:{ zzc -> 0x00c7, all -> 0x00f9 }
        r1 = r1.createFromParcel(r3);	 Catch:{ zzc -> 0x00c7, all -> 0x00f9 }
        r1 = (com.google.android.gms.internal.zzcez) r1;	 Catch:{ zzc -> 0x00c7, all -> 0x00f9 }
        r3.recycle();
    ...
    L_0x0110:
        ...
        r1 = com.google.android.gms.internal.zzcji.CREATOR;	 Catch:{ zzc -> 0x0130, all -> 0x0144 }
        r1 = r1.createFromParcel(r7);	 Catch:{ zzc -> 0x0130, all -> 0x0144 }
        r1 = (com.google.android.gms.internal.zzcji) r1;	 Catch:{ zzc -> 0x0130, all -> 0x0144 }
        r7.recycle();
    L_0x0129:
        if (r1 == 0) goto L_0x006b;	 Catch:{ SQLiteFullException -> 0x00a0, SQLiteException -> 0x00da, all -> 0x00fe }
    L_0x012b:
    ...
    L_0x014c:
        ...
        r1 = com.google.android.gms.internal.zzcek.CREATOR;	 Catch:{ zzc -> 0x016c, all -> 0x0180 }
        r1 = r1.createFromParcel(r7);	 Catch:{ zzc -> 0x016c, all -> 0x0180 }
        r1 = (com.google.android.gms.internal.zzcek) r1;	 Catch:{ zzc -> 0x016c, all -> 0x0180 }
        r7.recycle();
    L_0x0165:
        if (r1 == 0) goto L_0x006b;	 Catch:{ SQLiteFullException -> 0x00a0, SQLiteException -> 0x00da, all -> 0x00fe }
    L_0x0167:
    ...
    L_0x022a:
        ...
        goto L_0x00c1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzcfh.zzbp(int):java.util.List<com.google.android.gms.common.internal.safeparcel.zza>");
    }

    public final boolean zzc(zzcek com_google_android_gms_internal_zzcek) {
        super.zzwB();
        byte[] zza = zzcjl.zza((Parcelable) com_google_android_gms_internal_zzcek);
