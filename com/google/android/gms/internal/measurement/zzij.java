...
public final class zzij extends zzhi {
    ...
    protected zzij(zzgm com_google_android_gms_internal_measurement_zzgm) {
        super(com_google_android_gms_internal_measurement_zzgm);
        this.zzapk = new zzjn(com_google_android_gms_internal_measurement_zzgm.zzbt());
        this.zzapg = new zzix(this);
        this.zzapj = new zzik(this, com_google_android_gms_internal_measurement_zzgm);
        this.zzapm = new zzip(this, com_google_android_gms_internal_measurement_zzgm);
    }
    ...
    protected final void zza(zzez com_google_android_gms_internal_measurement_zzez) {
        zzab();
        Preconditions.checkNotNull(com_google_android_gms_internal_measurement_zzez);
        this.zzaph = com_google_android_gms_internal_measurement_zzez;
        zzcu();
        zzkp();
    }

    final void zza(zzez com_google_android_gms_internal_measurement_zzez, AbstractSafeParcelable abstractSafeParcelable, zzdz com_google_android_gms_internal_measurement_zzdz) {
        zzab();
        zzfs();
        zzch();
        boolean zzkn = zzkn();
                ...
                if (zzp != null) {
                    ...
                    while (i3 < size) {
                        ...
                        if (abstractSafeParcelable2 instanceof zzew) {
                            try {
                                com_google_android_gms_internal_measurement_zzez.zza((zzew) abstractSafeParcelable2, com_google_android_gms_internal_measurement_zzdz);
                            } catch (RemoteException e) {
                                zzgf().zzis().zzg("Failed to send event to the service", e);
                            }
                        } else if (abstractSafeParcelable2 instanceof zzjz) {
                            try {
                                com_google_android_gms_internal_measurement_zzez.zza((zzjz) abstractSafeParcelable2, com_google_android_gms_internal_measurement_zzdz);
                            ...
                            try {
                                com_google_android_gms_internal_measurement_zzez.zza((zzee) abstractSafeParcelable2, com_google_android_gms_internal_measurement_zzdz);
    ...
    protected final void zzb(zzew com_google_android_gms_internal_measurement_zzew, String str) {
        Preconditions.checkNotNull(com_google_android_gms_internal_measurement_zzew);
        zzab();
        zzch();
        boolean zzkn = zzkn();
        boolean z = zzkn && zzga().zza(com_google_android_gms_internal_measurement_zzew);
        zzf(new zzir(this, zzkn, z, com_google_android_gms_internal_measurement_zzew, zzk(true), str));
    }

    protected final void zzb(zzif com_google_android_gms_internal_measurement_zzif) {
        zzab();
        zzch();
        zzf(new zzio(this, com_google_android_gms_internal_measurement_zzif));
    }

    protected final void zzb(zzjz com_google_android_gms_internal_measurement_zzjz) {
        zzab();
        zzch();
        boolean z = zzkn() && zzga().zza(com_google_android_gms_internal_measurement_zzjz);
        zzf(new zziv(this, z, com_google_android_gms_internal_measurement_zzjz, zzk(true)));
    }
    ...
    protected final void zzd(zzee com_google_android_gms_internal_measurement_zzee) {
        Preconditions.checkNotNull(com_google_android_gms_internal_measurement_zzee);
        zzab();
        zzch();
        zzgi();
        zzf(new zzis(this, true, zzga().zzc(com_google_android_gms_internal_measurement_zzee), new zzee(com_google_android_gms_internal_measurement_zzee), zzk(true), com_google_android_gms_internal_measurement_zzee));
    }
