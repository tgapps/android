...
final class zzgk<V> extends FutureTask<V> implements Comparable<zzgk> {
    ...
    zzgk(zzgh com_google_android_gms_internal_measurement_zzgh, Runnable runnable, boolean z, String str) {
        ...
        if (this.zzamj == Long.MAX_VALUE) {
            com_google_android_gms_internal_measurement_zzgh.zzgf().zzis().log("Tasks index overflow");
        }
    }

    public final /* synthetic */ int compareTo(Object obj) {
        zzgk com_google_android_gms_internal_measurement_zzgk = (zzgk) obj;
        if (this.zzamk != com_google_android_gms_internal_measurement_zzgk.zzamk) {
            return this.zzamk ? -1 : 1;
        } else {
            if (this.zzamj < com_google_android_gms_internal_measurement_zzgk.zzamj) {
                return -1;
            }
            if (this.zzamj > com_google_android_gms_internal_measurement_zzgk.zzamj) {
                return 1;
