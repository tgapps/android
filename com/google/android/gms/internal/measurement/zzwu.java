...
public abstract class zzwu<T> {
    ...
    private zzwu(zzxe com_google_android_gms_internal_measurement_zzxe, String str, T t) {
        this.zzbnv = null;
        this.zzbnw = null;
        this.zzbnx = null;
        if (com_google_android_gms_internal_measurement_zzxe.zzbod == null) {
            throw new IllegalArgumentException("Must pass a valid SharedPreferences file name or ContentProvider URI");
        }
        this.zzbnr = com_google_android_gms_internal_measurement_zzxe;
        String valueOf = String.valueOf(com_google_android_gms_internal_measurement_zzxe.zzboe);
        String valueOf2 = String.valueOf(str);
        this.zzbnt = valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf);
        valueOf = String.valueOf(com_google_android_gms_internal_measurement_zzxe.zzbof);
    ...
    private static zzwu<Double> zza(zzxe com_google_android_gms_internal_measurement_zzxe, String str, double d) {
        return new zzxb(com_google_android_gms_internal_measurement_zzxe, str, Double.valueOf(d));
    }

    private static zzwu<Integer> zza(zzxe com_google_android_gms_internal_measurement_zzxe, String str, int i) {
        return new zzwz(com_google_android_gms_internal_measurement_zzxe, str, Integer.valueOf(i));
    }

    private static zzwu<Long> zza(zzxe com_google_android_gms_internal_measurement_zzxe, String str, long j) {
        return new zzwy(com_google_android_gms_internal_measurement_zzxe, str, Long.valueOf(j));
    }

    private static zzwu<String> zza(zzxe com_google_android_gms_internal_measurement_zzxe, String str, String str2) {
        return new zzxc(com_google_android_gms_internal_measurement_zzxe, str, str2);
    }

    private static zzwu<Boolean> zza(zzxe com_google_android_gms_internal_measurement_zzxe, String str, boolean z) {
        return new zzxa(com_google_android_gms_internal_measurement_zzxe, str, Boolean.valueOf(z));
    }

    private static <V> V zza(zzxd<V> com_google_android_gms_internal_measurement_zzxd_V) {
        V zzsl;
        long clearCallingIdentity;
        try {
            zzsl = com_google_android_gms_internal_measurement_zzxd_V.zzsl();
