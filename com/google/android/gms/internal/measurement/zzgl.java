...
final class zzgl extends Thread {
    ...
    public zzgl(zzgh com_google_android_gms_internal_measurement_zzgh, String str, BlockingQueue<zzgk<?>> blockingQueue) {
    ...
    public final void run() {
        ...
        while (true) {
            zzgk com_google_android_gms_internal_measurement_zzgk = (zzgk) this.zzamm.poll();
            if (com_google_android_gms_internal_measurement_zzgk != null) {
                Process.setThreadPriority(com_google_android_gms_internal_measurement_zzgk.zzamk ? threadPriority : 10);
                com_google_android_gms_internal_measurement_zzgk.run();
            } else {
                try {
