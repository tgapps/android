...
public final class zzew {
    ...
    public static zzex<Integer> zzags = zzex.zzc("measurement.upload.max_batch_size", C.DEFAULT_BUFFER_SEGMENT_SIZE, C.DEFAULT_BUFFER_SEGMENT_SIZE);
    public static zzex<Integer> zzagt = zzex.zzc("measurement.upload.max_bundle_size", C.DEFAULT_BUFFER_SEGMENT_SIZE, C.DEFAULT_BUFFER_SEGMENT_SIZE);
