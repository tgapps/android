...
public final class zzey {
    ...
    public static zza<Integer> zzagw = zza.zzc("measurement.upload.max_batch_size", C.DEFAULT_BUFFER_SEGMENT_SIZE, C.DEFAULT_BUFFER_SEGMENT_SIZE);
    public static zza<Integer> zzagx = zza.zzc("measurement.upload.max_bundle_size", C.DEFAULT_BUFFER_SEGMENT_SIZE, C.DEFAULT_BUFFER_SEGMENT_SIZE);
    ...
    public static zza<Integer> zzahb = zza.zzc("measurement.upload.max_public_events_per_day", DefaultLoadControl.DEFAULT_MAX_BUFFER_MS, DefaultLoadControl.DEFAULT_MAX_BUFFER_MS);
    ...
    public static final class zza<V> {
        ...
        static zza<Double> zza(String str, double d, double d2) {
            zza<Double> com_google_android_gms_internal_measurement_zzey_zza = new zza(str, Double.valueOf(-3.0d), Double.valueOf(-3.0d));
            zzey.zzagi.add(com_google_android_gms_internal_measurement_zzey_zza);
            return com_google_android_gms_internal_measurement_zzey_zza;
        }

        static zza<Long> zzb(String str, long j, long j2) {
            zza<Long> com_google_android_gms_internal_measurement_zzey_zza = new zza(str, Long.valueOf(j), Long.valueOf(j2));
            zzey.zzagf.add(com_google_android_gms_internal_measurement_zzey_zza);
            return com_google_android_gms_internal_measurement_zzey_zza;
        }

        static zza<Boolean> zzb(String str, boolean z, boolean z2) {
            zza<Boolean> com_google_android_gms_internal_measurement_zzey_zza = new zza(str, Boolean.valueOf(z), Boolean.valueOf(z2));
            zzey.zzagg.add(com_google_android_gms_internal_measurement_zzey_zza);
            return com_google_android_gms_internal_measurement_zzey_zza;
        }

        static zza<Integer> zzc(String str, int i, int i2) {
            zza<Integer> com_google_android_gms_internal_measurement_zzey_zza = new zza(str, Integer.valueOf(i), Integer.valueOf(i2));
            zzey.zzage.add(com_google_android_gms_internal_measurement_zzey_zza);
            return com_google_android_gms_internal_measurement_zzey_zza;
        }

        static zza<String> zzd(String str, String str2, String str3) {
            zza<String> com_google_android_gms_internal_measurement_zzey_zza = new zza(str, str2, str3);
            zzey.zzagh.add(com_google_android_gms_internal_measurement_zzey_zza);
            return com_google_android_gms_internal_measurement_zzey_zza;
        }
        ...
        private static void zzil() {
            synchronized (zza.class) {
                ...
                zzec com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                for (zza com_google_android_gms_internal_measurement_zzey_zza : zzey.zzagg) {
                    com_google_android_gms_internal_measurement_zzey_zza.zzaim = com_google_android_gms_internal_measurement_zzey_zza.zzaik.get();
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza2 : zzey.zzagh) {
                    com_google_android_gms_internal_measurement_zzey_zza2.zzaim = com_google_android_gms_internal_measurement_zzey_zza2.zzaik.get();
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza22 : zzey.zzagf) {
                    com_google_android_gms_internal_measurement_zzey_zza22.zzaim = com_google_android_gms_internal_measurement_zzey_zza22.zzaik.get();
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza222 : zzey.zzage) {
                    com_google_android_gms_internal_measurement_zzey_zza222.zzaim = com_google_android_gms_internal_measurement_zzey_zza222.zzaik.get();
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza2222 : zzey.zzagi) {
                    com_google_android_gms_internal_measurement_zzey_zza2222.zzaim = com_google_android_gms_internal_measurement_zzey_zza2222.zzaik.get();
                }
            }
        }
        ...
        private static void zzm() {
            synchronized (zza.class) {
                for (zza com_google_android_gms_internal_measurement_zzey_zza : zzey.zzagg) {
                    ...
                    String str = com_google_android_gms_internal_measurement_zzey_zza.zzny;
                    zzec com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                    com_google_android_gms_internal_measurement_zzey_zza.zzaik = zzik.zzf(str, ((Boolean) com_google_android_gms_internal_measurement_zzey_zza.zzaab).booleanValue());
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza2 : zzey.zzagh) {
                    zzik = zzey.zzagj;
                    str = com_google_android_gms_internal_measurement_zzey_zza2.zzny;
                    com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                    com_google_android_gms_internal_measurement_zzey_zza2.zzaik = zzik.zzv(str, (String) com_google_android_gms_internal_measurement_zzey_zza2.zzaab);
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza22 : zzey.zzagf) {
                    zzik = zzey.zzagj;
                    str = com_google_android_gms_internal_measurement_zzey_zza22.zzny;
                    com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                    com_google_android_gms_internal_measurement_zzey_zza22.zzaik = zzik.zze(str, ((Long) com_google_android_gms_internal_measurement_zzey_zza22.zzaab).longValue());
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza222 : zzey.zzage) {
                    zzik = zzey.zzagj;
                    str = com_google_android_gms_internal_measurement_zzey_zza222.zzny;
                    com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                    com_google_android_gms_internal_measurement_zzey_zza222.zzaik = zzik.zzd(str, ((Integer) com_google_android_gms_internal_measurement_zzey_zza222.zzaab).intValue());
                }
                for (zza com_google_android_gms_internal_measurement_zzey_zza2222 : zzey.zzagi) {
                    zzik = zzey.zzagj;
                    str = com_google_android_gms_internal_measurement_zzey_zza2222.zzny;
                    com_google_android_gms_internal_measurement_zzec = zzey.zzagd;
                    com_google_android_gms_internal_measurement_zzey_zza2222.zzaik = zzik.zzb(str, ((Double) com_google_android_gms_internal_measurement_zzey_zza2222.zzaab).doubleValue());
                }
            }
        }
    ...
    static void zza(zzec com_google_android_gms_internal_measurement_zzec) {
        zzagd = com_google_android_gms_internal_measurement_zzec;
        zza.zzm();
    }
}
