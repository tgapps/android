...
public final class zzcbf extends zzcbh {
    ...
    public final void zze(int i, Bundle bundle) {
        ...
        if (i == 1) {
            ...
            createPendingResult = this.mActivity.createPendingResult(this.zzaBk, intent, 1073741824);
        ...
        try {
            createPendingResult = this.mActivity.createPendingResult(this.zzaBk, new Intent(), 1073741824);
            if (createPendingResult != null) {
                createPendingResult.send(1);
            }
        } catch (Throwable e22) {
