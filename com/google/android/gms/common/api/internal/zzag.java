...
public final class zzag implements zzbc {
    ...
    public final <A extends AnyClient, T extends ApiMethodImpl<? extends Result, A>> T execute(T t) {
        try {
            ...
            zzav com_google_android_gms_common_api_internal_zzav = this.zzhf.zzfq;
            AnyClient anyClient = (Client) com_google_android_gms_common_api_internal_zzav.zzil.get(t.getClientKey());
