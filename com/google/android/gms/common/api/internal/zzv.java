...
public final class zzv<O extends ApiOptions> extends GoogleApi<O> {
    ...
    public zzv(Context context, Api<O> api, Looper looper, Client client, zzp com_google_android_gms_common_api_internal_zzp, ClientSettings clientSettings, AbstractClientBuilder<? extends SignInClient, SignInOptions> abstractClientBuilder) {
