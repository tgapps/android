...
public class AppMeasurement {
    ...
    @Keep
    protected void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @Nullable String str2, @Nullable Bundle bundle) {
    ...
    @Keep
    @WorkerThread
    protected int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        this.zzboe.zzwt();
