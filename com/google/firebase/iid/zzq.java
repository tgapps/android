...
final class zzq implements MessagingChannel {
    ...
    zzq(FirebaseApp firebaseApp, zzam com_google_firebase_iid_zzam, Executor executor) {
        this(firebaseApp, com_google_firebase_iid_zzam, executor, new zzas(firebaseApp.getApplicationContext(), com_google_firebase_iid_zzam));
    }

    private zzq(FirebaseApp firebaseApp, zzam com_google_firebase_iid_zzam, Executor executor, zzas com_google_firebase_iid_zzas) {
        this.zzaj = firebaseApp;
        this.zzak = com_google_firebase_iid_zzam;
        this.zzbf = com_google_firebase_iid_zzas;
        this.zzbg = executor;
    }
