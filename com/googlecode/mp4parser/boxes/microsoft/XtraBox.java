...
public class XtraBox extends AbstractBox {
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_0 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "toString", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, "java.lang.String"), 88);
        ajc$tjp_1 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getAllTagNames", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, "[Ljava.lang.String;"), 151);
        ajc$tjp_10 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setTagValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String:long", "name:value", TtmlNode.ANONYMOUS_REGION_ID, "void"), 289);
        ajc$tjp_2 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getFirstStringValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", TtmlNode.ANONYMOUS_REGION_ID, "java.lang.String"), 166);
        ajc$tjp_3 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getFirstDateValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", TtmlNode.ANONYMOUS_REGION_ID, "java.util.Date"), 183);
        ajc$tjp_4 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getFirstLongValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", TtmlNode.ANONYMOUS_REGION_ID, "java.lang.Long"), Callback.DEFAULT_DRAG_ANIMATION_DURATION);
        ajc$tjp_5 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getValues", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", TtmlNode.ANONYMOUS_REGION_ID, "[Ljava.lang.Object;"), 216);
        ajc$tjp_6 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "removeTag", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", TtmlNode.ANONYMOUS_REGION_ID, "void"), 236);
        ajc$tjp_7 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setTagValues", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String:[Ljava.lang.String;", "name:values", TtmlNode.ANONYMOUS_REGION_ID, "void"), 249);
        ajc$tjp_8 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setTagValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String:java.lang.String", "name:value", TtmlNode.ANONYMOUS_REGION_ID, "void"), 265);
        ajc$tjp_9 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setTagValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String:java.util.Date", "name:date", TtmlNode.ANONYMOUS_REGION_ID, "void"), 276);
    }
