...
final /* synthetic */ class MessagesStorage$$Lambda$26 implements Runnable {
    ...
    MessagesStorage$$Lambda$26(MessagesStorage messagesStorage, messages_Dialogs org_telegram_tgnet_TLRPC_messages_Dialogs, int i, int i2, int i3, int i4, int i5, Message message, int i6, LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
