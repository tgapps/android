...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    public OfflineLicenseHelper(UUID uuid, ExoMediaDrm<T> mediaDrm, MediaDrmCallback callback, HashMap<String, String> optionalKeyRequestParameters) {
        ...
        this.drmSessionManager = new DefaultDrmSessionManager(uuid2, exoMediaDrm, mediaDrmCallback, hashMap, new Handler(this.handlerThread.getLooper()), new EventListener() {
