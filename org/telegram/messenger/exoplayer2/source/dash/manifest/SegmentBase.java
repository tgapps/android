...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public final long getSegmentDurationUs(int sequenceNumber, long periodDurationUs) {
            if (this.segmentTimeline != null) {
                return (C.MICROS_PER_SECOND * ((SegmentTimelineElement) this.segmentTimeline.get(sequenceNumber - this.startNumber)).duration) / this.timescale;
            }
            int segmentCount = getSegmentCount(periodDurationUs);
            long segmentTimeUs = (segmentCount == -1 || sequenceNumber != (getFirstSegmentNum() + segmentCount) - 1) ? (this.duration * C.MICROS_PER_SECOND) / this.timescale : periodDurationUs - getSegmentTimeUs(sequenceNumber);
