...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private static long[][] calculateAccumulatedSampleSizes(org.telegram.messenger.exoplayer2.extractor.mp4.Mp4Extractor.Mp4Track[] r1) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.messenger.exoplayer2.extractor.mp4.Mp4Extractor.calculateAccumulatedSampleSizes(org.telegram.messenger.exoplayer2.extractor.mp4.Mp4Extractor$Mp4Track[]):long[][]
...
*/
    ...
    L_0x007b:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.exoplayer2.extractor.mp4.Mp4Extractor.calculateAccumulatedSampleSizes(org.telegram.messenger.exoplayer2.extractor.mp4.Mp4Extractor$Mp4Track[]):long[][]");
    }
    ...
    private void processMoovAtom(ContainerAtom moov) throws ParserException {
        ...
        while (i < containerAtom.containerChildren.size()) {
            ...
            if (atom.type == Atom.TYPE_trak) {
                Track track = AtomParsers.parseTrak(atom, containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd), C.TIME_UNSET, null, (mp4Extractor.flags & 1) != 0, mp4Extractor.isQuickTime);
                if (track != null) {
