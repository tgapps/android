...
public final class DownloaderConstructorHelper {
    ...
    public CacheDataSource buildCacheDataSource(boolean offline) {
        ...
        return new CacheDataSource(this.cache, this.priorityTaskManager == null ? upstream : new PriorityDataSource(upstream, this.priorityTaskManager, C.PRIORITY_DOWNLOAD), cacheReadDataSource, cacheWriteDataSink, 1, null);
    }
}
