...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        r1.actionBar.setActionBarMenuOnItemClick(new ActionBarMenuOnItemClick() {
        ...
        r1.fragmentView.setOnTouchListener(new OnTouchListener() {
        ...
        r1.textView2.setOnClickListener(new OnClickListener() {
