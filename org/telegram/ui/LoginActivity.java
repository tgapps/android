            ...
            r0.cancelButton.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    if (LoginActivityPasswordView.this.has_recovery) {
                        ...
                        ConnectionsManager.getInstance(LoginActivityPasswordView.this.this$0.currentAccount).sendRequest(new TL_auth_requestPasswordRecovery(), new RequestDelegate() {
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", R.string.ResetMyAccountWarningReset), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            ConnectionsManager.getInstance(LoginActivityPasswordView.this.this$0.currentAccount).sendRequest(req, new RequestDelegate() {
                    ...
                    if (Math.abs(ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).getCurrentTime() - LoginActivityResetWaitView.this.startTime) >= LoginActivityResetWaitView.this.waitTime) {
                        ...
                        builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", R.string.ResetMyAccountWarningReset), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                TL_account_deleteAccount req = new TL_account_deleteAccount();
                                req.reason = "Forgot password";
                                ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).sendRequest(req, new RequestDelegate() {
                                    public void run(TLObject response, final TL_error error) {
                                        AndroidUtilities.runOnUIThread(new Runnable() {
                                            public void run() {
        ...
        public LoginActivitySmsView(LoginActivity this$0, Context context, int type) {
            ...
            r0.wrongNumber.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    ...
                    ConnectionsManager.getInstance(LoginActivitySmsView.this.this$0.currentAccount).sendRequest(req, new RequestDelegate() {
                            ...
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    if (error.text.contains("PHONE_NUMBER_UNOCCUPIED")) {
                                        ...
                                        ok = true;
                                        ConnectionsManager.getInstance(LoginActivitySmsView.this.this$0.currentAccount).sendRequest(new TL_account_getPassword(), new RequestDelegate() {
                                            public void run(final TLObject response, final TL_error error) {
                                                AndroidUtilities.runOnUIThread(new Runnable() {
                                                    public void run() {
                                                        LoginActivitySmsView.this.this$0.needHideProgress();
        ...
        public PhoneView(LoginActivity this$0, Context context) {
            ...
            r1.codeField.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(android.text.Editable r12) {
                    /*
                    r11 = this;
                    r0 = org.telegram.ui.LoginActivity.PhoneView.this;
                ...
                L_0x0009:
                    ...
                    r2 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r2 = r2.codeField;
                    r2.setText(r0);
                    r2 = r0.length();
                    r3 = 0;
                ...
                L_0x0061:
                    ...
                    r8 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r8 = r8.codesMap;
                    r8 = r8.get(r7);
                ...
                L_0x0073:
                    ...
                    r9.append(r10);
                    r10 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r10 = r10.phoneField;
                    r10 = r10.getText();
                    r10 = r10.toString();
                    r9.append(r10);
                    r5 = r9.toString();
                    r9 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r9 = r9.codeField;
                    r0 = r7;
                    r9.setText(r7);
                    goto L_0x00a7;
                ...
                L_0x00a9:
                    ...
                    r6.append(r7);
                    r7 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r7 = r7.phoneField;
                    r7 = r7.getText();
                    r7 = r7.toString();
                    r6.append(r7);
                    r5 = r6.toString();
                    r6 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r6 = r6.codeField;
                ...
                L_0x00fb:
                    ...
                    r1 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r1 = r1.countryButton;
                    r7 = org.telegram.ui.LoginActivity.PhoneView.this;
                ...
                L_0x0132:
                    r7.setHintText(r4);
                    r4 = org.telegram.ui.LoginActivity.PhoneView.this;
                    r4.countryState = r3;
                    goto L_0x0158;
                L_0x013b:
                    r1 = org.telegram.ui.LoginActivity.PhoneView.this;
                ...
                L_0x01b6:
                    ...
                    return;
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.LoginActivity.PhoneView.2.afterTextChanged(android.text.Editable):void");
                }
            });
