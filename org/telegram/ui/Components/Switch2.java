...
public class Switch2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0) {
            ...
            switch2.paint.setColor(((((((int) (1132396544 + (-95.0f * switch2.progress))) & 255) << 16) | Theme.ACTION_BAR_VIDEO_EDIT_COLOR) | ((((int) (1127219200 + (38.0f * switch2.progress))) & 255) << 8)) | (((int) (1127022592 + (77.0f * switch2.progress))) & 255));
