...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.ui.Components.AlertsCreator.2.onClick(android.content.DialogInterface, int):void
...
*/
                    ...
                    L_0x0003:
                        ...
                        r0.putLong(r1, r2);
                        r1 = r6;
                        r2 = new org.telegram.ui.ReportOtherActivity;
                        r2.<init>(r0);
                    ...
                    L_0x0022:
                        ...
                        r1 = r3;
                        r1 = (int) r1;
                        r0 = r0.getInputPeer(r1);
                        r1 = r5;
                        r2 = 2;
                        r3 = 1;
                        if (r1 == 0) goto L_0x0066;
                    L_0x0035:
                        r1 = new org.telegram.tgnet.TLRPC$TL_messages_report;
                        r1.<init>();
                        r1.peer = r0;
                        r4 = r1.id;
                        r5 = r5;
                    ...
                    L_0x0049:
                        r2 = new org.telegram.tgnet.TLRPC$TL_inputReportReasonSpam;
                        r2.<init>();
                        r1.reason = r2;
                        goto L_0x0064;
                    L_0x0051:
                        if (r8 != r3) goto L_0x005b;
                        r2 = new org.telegram.tgnet.TLRPC$TL_inputReportReasonViolence;
                        r2.<init>();
                        r1.reason = r2;
                        goto L_0x0064;
                        if (r8 != r2) goto L_0x0064;
                        r2 = new org.telegram.tgnet.TLRPC$TL_inputReportReasonPornography;
                        r2.<init>();
                        r1.reason = r2;
                        goto L_0x008b;
                    L_0x0066:
                        r1 = new org.telegram.tgnet.TLRPC$TL_account_reportPeer;
                        r1.<init>();
                        r1.peer = r0;
                        ...
                        r3 = new org.telegram.ui.Components.AlertsCreator$2$1;
                        r3.<init>();
                        r2.sendRequest(r1, r3);
                        r2 = r7;
                        r3 = "ReportChatSent";
                        r4 = 2131494242; // 0x7f0c0562 float:1.8611987E38 double:1.0530980793E-314;
                        ...
                        return;
                        */
                        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.AlertsCreator.2.onClick(android.content.DialogInterface, int):void");
                    }
                });
                return builder.create();
            }
    ...
    public static Dialog createColorSelectDialog(Activity parentActivity, long dialog_id, boolean globalGroup, boolean globalAll, Runnable onSelect) {
        ...
        if (globalGroup) {
            ...
            if (preferences.contains(stringBuilder.toString())) {
                ...
                anonymousClass52 = new OnClickListener() {
                ...
                builder2.setPositiveButton(string, anonymousClass5);
                z3 = globalGroup;
                j2 = j3;
                runnable = onSelect;
        ...
        j = j3;
        selectedColor = onSelect;
        anonymousClass52 = /* anonymous class already generated */;
        builder2.setPositiveButton(string, anonymousClass5);
        z3 = globalGroup;
        j2 = j3;
        runnable = onSelect;
    ...
    public static Dialog createVibrationSelectDialog(Activity parentActivity, BaseFragment parentFragment, long dialog_id, String prefKeyPrefix, Runnable onSelect) {
        ...
        while (true) {
            ...
            if (a2 < descriptions2.length) {
                ...
                AnonymousClass8 anonymousClass8 = r1;
                final long j2 = j;
                ...
                AnonymousClass8 anonymousClass82 = new View.OnClickListener() {
                    public void onClick(View v) {
                ...
                cell2.setOnClickListener(anonymousClass8);
                a = a3 + 1;
                linearLayout = linearLayout2;
                j = dialog_id;
                z = true;
            ...
            if (a2 < descriptions2.length) {
                ...
                AnonymousClass14 anonymousClass142 = new View.OnClickListener() {
                    public void onClick(android.view.View r1) {
                        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.ui.Components.AlertsCreator.14.onClick(android.view.View):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
...
*/
                    ...
                    L_0x005d:
                        ...
                        r3 = "priority_group";
                        goto L_0x0080;
                        r3 = "priority_messages";
                        r1.putInt(r3, r2);
                        r1.commit();
                        r2 = r6;
                        if (r2 == 0) goto L_0x008f;
                        r2 = r6;
                        r2.dismissCurrentDialig();
                        r2 = r7;
                        ...
                        return;
                        */
                        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.AlertsCreator.14.onClick(android.view.View):void");
                    }
                };
