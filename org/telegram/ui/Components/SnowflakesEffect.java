        ...
        public void draw(Canvas canvas) {
            if (this.type != 0) {
                ...
                while (a < 6) {
                    ...
                    float cx = x1 * 0.66f;
                    float cy = 0.66f * y1;
                    canvas.drawLine(r0.x, r0.y, r0.x + x1, r0.y + y1, SnowflakesEffect.this.particleThinPaint);
                    ...
                    canvas2.drawLine(r0.x + cx, r0.y + cy, r0.x + ((float) ((Math.cos((double) angle2) * ((double) px1)) - (Math.sin((double) angle2) * ((double) py1)))), r0.y + y12, SnowflakesEffect.this.particleThinPaint);
                    canvas2 = canvas;
                    canvas2.drawLine(r0.x + cx, r0.y + cy, r0.x + ((float) (((-Math.cos((double) angle2)) * ((double) px1)) - (Math.sin((double) angle2) * ((double) py1)))), r0.y + ((float) (((-Math.sin((double) angle2)) * ((double) px1)) + (Math.cos((double) angle2) * ((double) py1)))), SnowflakesEffect.this.particleThinPaint);
                    angle += 1.0471976f;
                    a = a2 + 1;
                    px = px2;
                }
            ...
            canvas.drawPoint(r0.x, r0.y, SnowflakesEffect.this.particlePaint);
        }
    }
