...
public class CropAreaView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        int lineThickness = AndroidUtilities.dp(1073741824);
        int handleSize = AndroidUtilities.dp(1098907648);
        int handleThickness = AndroidUtilities.dp(1077936128);
    ...
    private void updateTouchAreas() {
        int touchPadding = AndroidUtilities.dp(1098907648);
