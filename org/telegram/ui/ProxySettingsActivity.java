...
public class ProxySettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        while (a < 2) {
            ...
            this.typeCell[a].setOnClickListener(new OnClickListener() {
        ...
        this.shareCell.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (ProxySettingsActivity.this.currentType == 1) {
                        ...
                        params.append("secret=").append(URLEncoder.encode(secret, C.UTF8_NAME));
                    } else {
