...
public class GroupCreateActivity extends BaseFragment implements OnClickListener, NotificationCenterDelegate {
    ...
    private class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            GroupCreateActivity.this.editText.measure(MeasureSpec.makeMeasureSpec(maxWidth - y, 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
            int i;
            if (spansContainer.animationStarted) {
                i = maxWidth;
...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.ui.GroupCreateActivity.GroupCreateAdapter.onCreateViewHolder(android.view.ViewGroup, int):org.telegram.messenger.support.widget.RecyclerView$ViewHolder
...
*/
        ...
        L_0x0002:
            r0 = new org.telegram.ui.Cells.GroupCreateUserCell;
            r1 = r3.context;
            r2 = 1;
            r0.<init>(r1, r2);
            goto L_0x0013;
        L_0x000b:
            r0 = new org.telegram.ui.Cells.GroupCreateSectionCell;
            r1 = r3.context;
            r0.<init>(r1);
            ...
            return r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.GroupCreateActivity.GroupCreateAdapter.onCreateViewHolder(android.view.ViewGroup, int):org.telegram.messenger.support.widget.RecyclerView$ViewHolder");
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (holder.getItemViewType() != 0) {
                ...
                if (groupCreateAdapter.searching) {
                    ...
                    if (i >= 0 && i < localCount) {
                        user = (User) groupCreateAdapter.searchResult.get(i);
                        ...
                        if (user != null) {
                            if (i >= localCount) {
                            ...
                            } else if (i > localCount && !TextUtils.isEmpty(user.username)) {
                                ...
                                try {
                                    ...
                                    indexOf = user.username.toLowerCase().indexOf(charSequence);
                                    index = indexOf;
                                    if (indexOf == -1) {
                                        ...
                                        try {
                                            ...
                                            user2 = user;
                                            cell.setUser(user2, name, username);
                                            cell.setChecked(GroupCreateActivity.this.selectedContacts.indexOfKey(user2.id) < 0, false);
                                            return;
                                        }
                                    }
                                    username2 = null;
                                    ...
                                    user2 = user;
                                    cell.setUser(user2, name, username);
                                    if (GroupCreateActivity.this.selectedContacts.indexOfKey(user2.id) < 0) {
                                    }
                                    cell.setChecked(GroupCreateActivity.this.selectedContacts.indexOfKey(user2.id) < 0, false);
                                    return;
                                }
                        ...
                        user = (User) groupCreateAdapter.searchAdapterHelper.getGlobalSearch().get((i - localCount) - 1);
                    }
                    if (user != null) {
                        if (i >= localCount) {
                            charSequence = groupCreateAdapter.searchAdapterHelper.getLastFoundUsername();
                    ...
                    user = (User) groupCreateAdapter.contacts.get(i);
                    username = null;
                }
                user2 = user;
                cell.setUser(user2, name, username);
    ...
    public void didReceivedNotification(int r1, int r2, java.lang.Object... r3) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.ui.GroupCreateActivity.didReceivedNotification(int, int, java.lang.Object[]):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:306)
...
*/
        /*
        r0 = this;
        r0 = org.telegram.messenger.NotificationCenter.contactsDidLoaded;
    ...
    L_0x0032:
        ...
        r3 = r5.listView;
        r3 = r3.getChildAt(r0);
        r4 = r3 instanceof org.telegram.ui.Cells.GroupCreateUserCell;
        if (r4 == 0) goto L_0x004d;
        r4 = r3;
        r4 = (org.telegram.ui.Cells.GroupCreateUserCell) r4;
        r4.update(r1);
        r0 = r0 + 1;
        goto L_0x003b;
        goto L_0x0058;
    L_0x0051:
        r0 = org.telegram.messenger.NotificationCenter.chatDidCreated;
        if (r6 != r0) goto L_0x0058;
        r5.removeSelfFromStack();
    L_0x0058:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.GroupCreateActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public View createView(Context context) {
        ...
        this.fragmentView = new ViewGroup(context) {
            protected void onMeasure(int r1, int r2) {
                /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: org.telegram.ui.GroupCreateActivity.2.onMeasure(int, int):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
...
*/
            ...
            L_0x001b:
                ...
                r2 = org.telegram.messenger.AndroidUtilities.dp(r2);
                r3 = org.telegram.ui.GroupCreateActivity.this;
                r3 = r3.scrollView;
                ...
                r3 = r3.listView;
                r5 = android.view.View.MeasureSpec.makeMeasureSpec(r0, r4);
                r6 = org.telegram.ui.GroupCreateActivity.this;
                r6 = r6.scrollView;
                r6 = r6.getMeasuredHeight();
                r6 = r1 - r6;
                r6 = android.view.View.MeasureSpec.makeMeasureSpec(r6, r4);
                r3.measure(r5, r6);
                r3 = org.telegram.ui.GroupCreateActivity.this;
                r3 = r3.emptyView;
                r5 = android.view.View.MeasureSpec.makeMeasureSpec(r0, r4);
                ...
                r6 = r6.getMeasuredHeight();
                r6 = r1 - r6;
                r4 = android.view.View.MeasureSpec.makeMeasureSpec(r6, r4);
                r3.measure(r5, r4);
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.GroupCreateActivity.2.onMeasure(int, int):void");
            }
