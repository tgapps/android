...
public class SharedDocumentCell extends FrameLayout implements FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context) {
        ...
        r0.thumbImageView.getImageReceiver().setDelegate(new ImageReceiverDelegate() {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(56.0f) + this.needDivider, 1073741824));
    }
